...
var Auth0Provider = function (opts) {
    ...
    var client = useState(function () { return new Na(toAuth0ClientOptions(clientOpts)); })[0];
...
export { Auth0Context, Auth0Provider, va as InMemoryCache, ya as LocalStorageCache, OAuthError, Ua as User, initialContext, useAuth0, withAuth0, withAuthenticationRequired };
