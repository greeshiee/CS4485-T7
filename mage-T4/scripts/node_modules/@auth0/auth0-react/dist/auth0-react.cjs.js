...
var Auth0Provider = function (opts) {
    ...
    var client = React.useState(function () { return new Na(toAuth0ClientOptions(clientOpts)); })[0];
...
var withAuth0 = function (Component, context) {
    ...
    return function WithAuth(props) {
        return (React__default["default"].createElement(context.Consumer, null, function (auth) { return (React__default["default"].createElement(Component, __assign({}, props, { auth0: auth }))); }));
    };
};
