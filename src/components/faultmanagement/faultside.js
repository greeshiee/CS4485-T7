...
function FaultSide() {
  return (
    <div>
      <h1 className="text-foreground font-bold text-2xl md:text-3xl xl:text-4xl">Fault Management - Side Panel</h1>
      <p>This is the Fault Management Side Panel. Use this panel to view details of specific faults.</p>
    </div>
  );
}
